<?php
    ...
    require_once __DIR__ . "/../models/Users.php"; //DIR -> indica la ruta del archivo actual
    ...
    class UserController { //el controlador es el nexo de unión entre la vista y los modelos -> será el encargado de invocar al modelo para recuperar los datos de la bbd y enviarlos a la vista para que se encargue de su visualización
        ...
        public function mostrar_registro(){
            ...
            $vista= __DIR__ . '/../views/users/registro.php'; //se crean estos archivos con esta estructura que ayuda a tener una carpeta con vista del registro y otra con la interfaz
            require __DIR__ . '/../views/layout.php'; //se pone aqui el require para que cargue justo en la función, no se pone antes
        }
    }
